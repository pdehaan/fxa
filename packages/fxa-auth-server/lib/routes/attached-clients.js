...
const ConnectedServicesFactory = require('../../../fxa-shared/connected-services/ConnectedServicesFactory');
      ...
      handler: async function (request) {
        ...
        const factory = new ConnectedServicesFactory({
          ...
          synthesizeClientName: (session) => {
            devices.synthesizeName(session);
          },
          getClientFormatter: () => {
            return clientUtils;
          },
        ...
        return await factory.build(uid, request.app.acceptLanguage);
      },
    },
    {
      method: 'POST',
